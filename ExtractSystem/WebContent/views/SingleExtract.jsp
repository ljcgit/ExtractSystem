...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li  class="active"><a href="<%= basePath %>/SingleExtract"><i class="fa fa-circle-o"></i> 单组抽取</a></li>
            <li><a href="<%= basePath %>/MultipleExtract"><i class="fa fa-circle-o"></i> 多组抽取</a></li>
  ...
  <div class="content-wrapper">
    ...
    <c:if test="${squard!=null }">
            ...
            <!-- /.box-body -->
              <div class="box-footer">
                <button type="submit" class="btn btn-default"  onclick="window.location.href = '<%= basePath%>/SingleExtract'">返回</button>
