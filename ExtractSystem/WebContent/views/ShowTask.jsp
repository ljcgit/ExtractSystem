      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<%= basePath %>/HistoricalTask"><i class="fa fa-circle-o"></i> 历史任务记录</a></li>
          </ul>
        </li>
    ...
    <c:if test="${squard!=null }">
            ...
            <div class="box-body no-padding">
              <table class="table table-striped">
                ...
                <tr>
                  <td>startDate</td>
                  <td> ${requestScope.task.startDate }</td>
                </tr>
                <tr>
                  <td>endDate</td>
                  <td> ${requestScope.task.endDate }</td>
                </tr>
                <tr>
                  <td>intro</td>
                  <td> ${requestScope.task.intro }</td>
                </tr>
                <tr>
                  <td>tid</td>
                  <td>${squard.tid }</td>
    ...
    <c:if test="${staffs!=null }">
      ...
      <!-- /.row -->  
       ...
       <div class="box-footer">
           	<button type="submit" class="btn btn-info pull-right"  id="outExcel">导出</button>
       </div>  
        <div class="box-footer">
           	<button type="submit" class="btn btn-info pull-right" onclick="window.location.href='<%= basePath %>/HistoricalTask'">返回</button>
       </div>   
      </c:if>
...
<script>
  $(function () {
    ...
    $("#outExcel").click(function(){
    	  htmlobj=$.ajax({url:"<%= basePath %>/OutExcelServlet?id=${task.id }",async:false});
  	});
  })
</script>
</body>
