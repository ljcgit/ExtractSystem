    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<%=basePath %>/NewTask"><i class="fa fa-circle-o"></i> 新建任务</a></li>
    ...
    <section class="content">
		...
		<div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">任务表单</h3>
            </div>

            <form class="form-horizontal" action="<%= basePath %>/createTask" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="startDate" class="col-sm-2 control-label">StartData</label>
                ...
                <div class="form-group">
                  <label for="endDate" class="col-sm-2 control-label">EndData</label>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea rows="3" cols="20" id="intro" name="intro"></textarea>
                  </div>
                </div>
